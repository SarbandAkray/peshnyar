      ...
      <section className="bg-gray-900 py-8 px-5 ">
        <div className="mx-auto px-5 w-full">
          <form className="mb-6 max-w-md">
            ...
            <button
              type="submit"
              className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800 bg-red-400"
            >
              Post comment
            </button>
          </form>
